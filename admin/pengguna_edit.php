...
if(isset($_POST['btn-simpan'])){
    ...
    if($_POST['password'] != null || $_POST['password'] == ''){
        ...
        $query = "UPDATE `user` SET `nama_user`='$nama',`username`='$username' ,`password`='$pass',`outlet_id`='$outlet',`role`='$role' WHERE id_user = '$id_user'";  
        echo $query;
    }else{
        $outlet = $_POST['outlet_id'];
        $query = "UPDATE `user` SET `nama_user`='$nama',`username`='$username' ,`outlet_id`='$outlet',`role`='$role' WHERE id_user = '$id_user'";  
        echo $query;
    }
