...
<head>
    ...
    <!-- Icon -->
    <script src="https://kit.fontawesome.com/3640bc97c1.js" crossorigin="anonymous"></script>
    <!-- Menu CSS -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="outlet.php" class="waves-effect <?php if($title=='outlet'){echo 'active';} ?>"><i class="fa fa-suitcase fa-fw" aria-hidden="true"></i> Outlet Laundry</a>
                    </li>
                    <li>
                        <a href="paket.php" class="waves-effect <?php if($title=='paket'){echo 'active';} ?>"><i class="fa fa-archive fa-fw" aria-hidden="true"></i> Paket Laundry</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="pelanggan.php" class="waves-effect <?php if($title=='pelanggan'){echo 'active';}?>"><i class="fa fa-users fa-fw" aria-hidden="true"></i> Member</a>
                    </li>
                    <li>
