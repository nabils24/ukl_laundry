	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(assets/login/images/Laundry123.jpg);">
				...
				<form class="login100-form validate-form" method="POST" action="ceklogin.php">
					...
					<div class="container-login100-form-btn mt-3">
						<small>Dibuat Oleh Nabil Sahsada Suratno | Template Login By Boostrap | ColorLib</small>
					</div>
				</form>
			</div>
		</div>
